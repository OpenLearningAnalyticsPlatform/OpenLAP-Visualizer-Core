...
public class VisualizationFrameworkControllerTest {
    ...
    public void getListOfVisualizationFrameworks() {
        try {
            ...
            log.debug("Number of visualization frameworks existing in the system : " + visualizationFrameworksDetailsResponse.getVisualizationFrameworks().size());
    ...
    public void updateVisualizationFrameworkDetails() {
        try {
            ...
            log.debug("Framework chosen at random, finalized visualization framework update URL: " + visFrameworkUpdateURL);
